...
export class HomeComponent implements OnInit {
  ...
  features = [
    {
      ...
      description: "Calcula tu 1RM, puntuación Wilks y nivel de fuerza con precisión científica.",
      link: "/calculators",
    },
    {
      icon: "fitness_center",
      title: "Seguimiento de Entrenamientos",
      description: "Registra tus entrenamientos y observa tu progreso a lo largo del tiempo.",
      link: "/workouts",
    },
    {
      icon: "assignment",
      title: "Plantillas Personalizadas",
      description: "Crea y comparte rutinas de entrenamiento adaptadas a tus objetivos.",
      link: "/templates",
    },
    {
      icon: "trending_up",
      title: "Análisis de Progreso",
      description: "Visualiza tu evolución con gráficos detallados y métricas avanzadas.",
      link: "/dashboard",
    },
    {
      icon: "leaderboard",
      title: "Estándares de Fuerza",
      description: "Compara tu rendimiento con estándares internacionales de powerlifting.",
      link: "/standards",
    },
    {
      icon: "person",
      title: "Perfil Personalizado",
      description: "Gestiona tu información personal y configuraciones de entrenamiento.",
      link: "/profile",
    },
  ]
  ...
  testimonials = [
    ...
    },
    {
      ...
      quote: "Uso FuerzApp con todos mis clientes. La capacidad de crear plantillas personalizadas es fantástica.",
    },
    {
      name: "Miguel Torres",
      role: "Atleta Amateur",
